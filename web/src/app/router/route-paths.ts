export const APP_ROUTE_PATHS = {
  ...
  home: "/app",
  room: "/rooms/:room_id",
  roomSession: "/rooms/:room_id/sessions/:session_key",
  roomConversation: "/rooms/:room_id/conversations/:conversation_id",
  contacts: "/contacts",
  skills: "/capability/skills",
  skillDetail: "/capability/skills/:skill_name",
  connectors: "/capability/connectors",
  connectorDetail: "/capability/connectors/:connector_id",
