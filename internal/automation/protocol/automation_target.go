...
import (
	"errors"
	coreprotocol "github.com/nexus-research-lab/nexus/internal/protocol"
	"strings"
)
...
func (t SessionTarget) Validate() error {
	...
	case SessionTargetBound:
		...
		if _, err := coreprotocol.RequireStructuredSessionKey(boundSessionKey); err != nil {
			return err
		}
...
func (s Source) Validate() error {
	...
	if strings.TrimSpace(s.SessionKey) != "" {
		if _, err := coreprotocol.RequireStructuredSessionKey(s.SessionKey); err != nil {
			return err
		}
	}
	return nil
