...
- Grouped Room guidance consumed by a running Goal into the Goal's reply round, kept the model's final response after the user's interjection, and cleared stale Agent reply placeholders from authoritative Room subscription snapshots.
